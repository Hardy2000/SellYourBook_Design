...
public class Schedule_Pickup_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_schedule__pickup);
        ...
        tool_Bar_Title.setText("Schedule Pickup");
    }
}