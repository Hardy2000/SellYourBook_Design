...
public class Add_Pick_Up_Details_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add__pick__up__details_);
        ...
        tool_Bar_Title.setText("Add pick up details");
