...
public class Add_Bank_Details_activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add__bank__details_activity);
        ...
        tool_Bar_Title.setText("Add bank details");
    }
}